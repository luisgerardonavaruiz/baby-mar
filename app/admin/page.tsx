        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-ink/60">
              {rsvps.length} {rsvps.length === 1 ? "confirmación" : "confirmaciones"} ·{" "}
              {totalPersonas} {totalPersonas === 1 ? "persona" : "personas"} en total
            </p>
          </div>
          <button
        ...
        <div className="mt-6 overflow-hidden rounded-2xl bg-white shadow-sm">
          {rsvps.length === 0 ? (
            <p className="p-8 text-center text-ink/50">
              Todavía no hay confirmaciones. Cuando alguien confirme, aparecerá aquí.
            </p>
          ) : (
