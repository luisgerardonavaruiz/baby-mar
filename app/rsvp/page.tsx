    ...
    return (
      <main className="flex-1 flex flex-col items-center justify-center bg-blue-pale px-6 py-16 text-center">
        ...
        <p className="mt-2 max-w-sm text-ink/70">
          Ya anotamos tu asistencia al Baby Shower de Gerardo. Nos vemos el
          29 de agosto a las 3:00 PM. 🩵
        </p>
        <Link
          href="/"
    ...
    <main className="flex-1 bg-blue-pale px-6 py-12 sm:py-16">
      <div className="mx-auto max-w-md">
        ...
        <p className="mt-2 text-ink/70">
          Nos dará mucho gusto contar contigo en el Baby Shower de Gerardo.
        </p>
        ...
        >
          <div>
            <label htmlFor="nombre" className="block text-sm font-semibold text-ink/80">
              Nombre completo
            </label>
            <input
              id="nombre"
